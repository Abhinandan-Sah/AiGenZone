...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome to AiGenZone! Let's start creating!")
      ...
      >
        <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-400">Join the future of component development</CardDescription>
          </CardHeader>
          <CardContent>
